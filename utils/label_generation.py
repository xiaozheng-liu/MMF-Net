...
def process_grasp_labels(end_points):
    ...
    end_points['batch_grasp_point'] = batch_grasp_points  # (2, 1024, 3)
    end_points['batch_grasp_view_rot'] = batch_grasp_views_rot  # (2, 1024, 300, 3, 3)
    end_points['batch_grasp_score'] = batch_grasp_scores  # (2, 1024, 300, 12, 4)
    end_points['batch_grasp_width'] = batch_grasp_widths  # (2, 1024, 300, 12, 4)
    end_points['batch_grasp_view_graspness'] = batch_grasp_view_graspness  # (2, 1024, 300)
...
def match_grasp_view_and_label(end_points):
    ...
    end_points['batch_grasp_score'] = top_view_grasp_scores  # (B, Ns, A, D)  (2, 1024, 12 ,4)
    end_points['batch_grasp_width'] = top_view_grasp_widths  # (B, Ns, A, D)  (2, 1024, 12 ,4)

    return top_template_views_rot, end_points  # (2, 1024, 3, 3)
