...
def resnet18(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet18'], model_dir='/home/liu/graspnet-baseline/1217washang-rand-256/models/cnn/ResNet_pretrained_mdl'
            )
        )
    return model
...
def resnet34(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet34'], model_dir='/home/liu/graspnet-baseline/1217washang-rand-256/models/cnn/ResNet_pretrained_mdl'
            )
        )
    return model
...
def resnet50(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet50'], model_dir='/home/liu/graspnet-baseline/1217washang-rand-256/models/cnn/ResNet_pretrained_mdl'
            )
        )
    return model
...
def resnet101(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet101'], model_dir='/home/liu/graspnet-baseline/1217washang-rand-256/models/cnn/ResNet_pretrained_mdl'
            )
        )
    return model
...
def resnet152(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet152'], model_dir='/home/liu/graspnet-baseline/1217washang-rand-256/models/cnn/ResNet_pretrained_mdl'
            )
        )
    return model
